...
plt.show()
'''
var = data.groupby('Segment').TT.mean()
fig = plt.figure()
ax1 = fig.add_subplot(1,1,1)
ax1.set_xlabel('Segment')
ax1.set_ylabel('TAlKTIME')
ax1.set_title("Segment and mean TAlKTIME")
...
ax1.set_ylabel('TAlKTIME')
ax1.set_title("Skill and the mean TALKTIME")
var.plot(kind='line',grid=True)
plt.show()


var = data.groupby('Disposition').TT.mean()
fig = plt.figure()
ax1 = fig.add_subplot(1,1,1)
ax1.set_xlabel('Disposition')
ax1.set_ylabel('TAlKTIME')
ax1.set_title("Disposition AND their Talktime mean")
var.plot(kind='line',grid=True)
plt.show()